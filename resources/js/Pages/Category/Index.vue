...
import CategoryTable from '@/Components/Tables/Category/CategoryTable.vue';
...
const onCreate = () => {
    ...
    formDialog.value.title = 'Crear nueva categoría';
};

const onEdit = (model) => {
    formDialog.value.visible = true;
    formDialog.value.title = 'Editar categoría';
...
<template>
    ...
    <AdminLayout title="Categorías">
        ...
        <section class="mx-auto max-w-screen-xl">
            <CategoryTable :data="list" @table:creating="onCreate" @table:updating="onEdit"
